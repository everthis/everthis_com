...
docpadConfig = {
    ...
    templateData:
        ...
        site:
            ...
            description: """
                Personal website mainly for web development.
                """

            # The website keywords (for SEO) separated by commas
            keywords: """
                web development, javascript, js, sass, compass, CSS, HTML, hardware, software, networking, Linux, grunt, gruntjs, bower, yeoman
                """
            ...
            scripts: [
                ...
                '/scripts/back_to_top.js'
                '/scripts/ripple.js'
                '/scripts/parent_height_of_absolute_child.js'
            ]
